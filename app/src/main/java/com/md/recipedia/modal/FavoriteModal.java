...
public class FavoriteModal {
    ...
    int recipe__banner;
    public FavoriteModal() {
    }

    public FavoriteModal(String recipe_name, String recipe_serves, String recipe_makes, String recipe_preparation, String recipe_cooking, String recipe_ingredients, String recipe_method, int recipe__banner) {
